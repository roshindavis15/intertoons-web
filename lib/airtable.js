    ...
    if (projectIds.length > 0) {
      ...
      projects = portfolioResponse.records
        ...
        .map(r => ({
          ...
          category: r.fields['categroy'] || r.fields['category'] || r.fields['Category'] || r.fields['Categroy'] || r.fields['short title'] || r.fields['Short Title'] || '',
          image: r.fields['featured image']?.[0]?.url || r.fields['Featured Image']?.[0]?.url || null,
          tags: (r.fields['categroy'] || r.fields['category'] || r.fields['Category'] || r.fields['Categroy'] || r.fields['Tags'] || '')
            ? (r.fields['categroy'] || r.fields['category'] || r.fields['Category'] || r.fields['Categroy'] || r.fields['Tags'] || '')
                .toString()
                .split('|')
                .map(t => t.trim())
                .filter(Boolean)
